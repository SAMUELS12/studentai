        ...
        <div className="bg-card/80 border border-slate-700/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-black/20 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={submitting}
              ...
              {submitting ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <LogIn size={16} />}
          ...
          <div className="mt-6 pt-5 border-t border-slate-700/20 text-center">
            <p className="text-xs text-slate-500">
              ...
              <Link to="/register" className="text-indigo-400 hover:text-indigo-300 transition-colors font-medium inline-flex items-center gap-0.5">
